...
#include "PSWidget_ResultMessagePopup.generated.h"


UCLASS()
class PROTOSURVIVOR_API UPSWidget_ResultMessagePopup : public UCSWidget_BasePopup
{
	GENERATED_BODY()
...
public:
	...
	UWidgetAnimation* ResultPopupAnimation;
